...
insert into About (Carnet, nombre, apellido, seccion) values ('2021484', 'Edson', 'Patzán', 'IN5CV');
insert into About (Carnet, nombre, apellido, seccion) values ('2021418', 'Estuardo', 'Rodas', 'IN5CV');
insert into About (Carnet, nombre, apellido, seccion) values ('2021420', 'Diego', 'Morales', 'IN5CV');
insert into About (Carnet, nombre, apellido, seccion) values ('2021400', 'Edgar', 'Gómez', 'IN5CV');
insert into About (Carnet, nombre, apellido, seccion) values ('2021399', 'Jefferson', 'Tejaxún', 'IN5CV');
insert into About (Carnet, nombre, apellido, seccion) values ('2020193', 'Wilmer', 'Chajón', 'IN5CV');
insert into About (Carnet, nombre, apellido, seccion) values ('2021584', 'Carlos', 'López', 'IN5CV');
insert into About (Carnet, nombre, apellido, seccion) values ('2021594', 'Juan', 'Herrera', 'IN5CV');
insert into About (Carnet, nombre, apellido, seccion) values ('2021670', 'Diego', 'Arriola', 'IN5CV');
insert into About (Carnet, nombre, apellido, seccion) values ('2017379', 'Angel', 'Escobar', 'IN5CV');
select * from About;